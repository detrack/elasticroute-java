...
public class Plan {
     ...
     *
     * @param stopList {@code List<Stop>} A list of stops to plan
     * @param depotList {@code List<Depot>} A list of depots
     * @param vehicleList {@code List<Vehicle>} A list of vehicles
     * @param generalSettings {@code GeneralSettings} The general settings for the plan
     */
